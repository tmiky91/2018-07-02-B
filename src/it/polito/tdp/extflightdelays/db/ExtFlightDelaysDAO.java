...
public class ExtFlightDelaysDAO {
	...
	public List<Rotta> getRotte(Map<Integer, Airport> idMap, String numVoli) {
		final String sql=	"select f1.ORIGIN_AIRPORT_ID as id1, f1.DESTINATION_AIRPORT_ID as id2, avg(f1.ELAPSED_TIME) as media " + 
							"from flights as f1 " + 
		...
		try {
			Connection conn = ConnectDB.getConnection();
			PreparedStatement st = conn.prepareStatement(sql);
			st.setInt(1, Integer.parseInt(numVoli));
			ResultSet rs = st.executeQuery();
